        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="ma_tgia" readonly value="<?= $tacgia['ma_tgia']?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên tác giả</span>
                        <input type="text" class="form-control" name="ten_tgia" value = "<?= $tacgia['ten_tgia']?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Hình ảnh</span>
                        <input type="text" class="form-control" name="hinh_tgia" value = "<?= $tacgia['hinh_tgia']?>">
                    </div>
                    </div>
