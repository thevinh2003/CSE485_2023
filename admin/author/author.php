...
$stmt->execute();
$tacgia = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
                        ...
                        <?php foreach ($tacgia as $item) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Bạn có chắc chắn muốn xoá?')" href="delete_author.php?id=<?=$item['ma_tgia']?>"><i class="ms-4 fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
